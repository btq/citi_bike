...
def scrape_weather(from_date,to_date):
	...
	for day in dates:
		url = "https://api.weathersource.com/v1/f5d417837e1db53fa190/history_by_postal_code.json?period=hour&postal_code_eq=11222&country_eq=US&limit=24&timestamp_between=%sT00:00+00:00,%sT24:00+00:00&fields=timestamp,snowfall,temp,precip"% (day,day)
